...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-20 md:py-24 border-t border-neutral-800">
      <Container>
        <Reveal>
              ...
              <Card className="p-0">
                <div className="grid lg:grid-cols-12">
                  ...
                  <div className="lg:col-span-4 p-8 border-b lg:border-b-0 lg:border-r border-neutral-900">
                    ...
                    <p className="mt-4 text-neutral-400 leading-relaxed">{cs.summary}</p>

                    <div className="mt-6 flex flex-wrap gap-2 text-xs text-neutral-500">
                      {cs.tech.map((tech) => (
                        <span key={tech} className="border border-neutral-800 px-2 py-1 rounded">
                          {tech}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="lg:col-span-8 p-8">
                    <div className="grid md:grid-cols-3 gap-6">
                      <div>
                        ...
                        <p className="mt-3 text-neutral-300 leading-relaxed">{cs.problem}</p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="mt-3 text-neutral-300 leading-relaxed">{cs.approach}</p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="mt-3 text-neutral-300 leading-relaxed">{cs.impact}</p>
                      </div>
                    </div>
                  </div>
                </div>
