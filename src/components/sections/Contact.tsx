      ...
      <Container>
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <div className="mt-8 space-y-3 text-sm">
              <p className="text-neutral-300">
                Email:{" "}
                <a className="underline hover:text-white" href="mailto:your@email.com">
                  your@email.com
                </a>
              </p>
          ...
          >
            ...
            <label className="block text-sm text-neutral-300 mt-5">Message</label>
            <textarea
            ...
            <p className="mt-3 text-xs text-neutral-500">
              For now this form is UI only. Next step: Netlify Forms.
            </p>
          </form>
        </div>
      </Container>
